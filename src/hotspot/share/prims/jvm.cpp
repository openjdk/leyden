...
JVM_ENTRY_PROF(jclass, JVM_FindClassFromLoader, JVM_FindClassFromLoader(JNIEnv* env, const char* name,
...
JVM_ENTRY_PROF(jobjectArray, JVM_GetStackTrace, JVM_GetStackTrace(JNIEnv *env, jobject jthread))
