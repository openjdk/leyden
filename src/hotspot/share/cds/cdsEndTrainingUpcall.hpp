...
private:
  ...
  static MethodPattern* _method_pattern;

  static bool include_method_callback(Symbol* class_name, Symbol* method_name, Symbol* signature);
  static bool parse_vm_command();
