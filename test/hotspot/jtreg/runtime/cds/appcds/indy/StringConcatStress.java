 ...
 * @run driver StringConcatStress
 */

import jdk.test.lib.helpers.ClassFileInstaller;

public class StringConcatStress extends IndyTestBase {
    static final String appJar = ClassFileInstaller.getJarPath("app.jar");
    static final String mainClass = "StringConcatStressApp";

    public static void main(String[] args) throws Exception {
        setup(appJar);
        test("Lots and lots of string concats", mainClass, "check", "check", RUN_STATIC | RUN_AOT | RUN_BENCH);
    }
}
